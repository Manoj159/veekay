   ...
   <div class="container">
      <div class="row">
         <div class="col-md-3">
            ...
            <a href="https://www.instagram.com/veekay_cabs?igsh=MWF5Z3dxNXVqa2Vkdw=="> <img src="<?= base_url(); ?>/assets/img/insta.png"  alt="veekaycabs Provides Self Drive car rental services in Delhi NCR" ></a>
         </div>
         <div class="col-md-3">
...
<div class="copyright text-center">
   <p class="m-0">© veekaycabs <?php echo date('Y') ?>   | Developed by <a href="https://www.bannotechnologies.com/" target="_blank" style="color:white;font-weight:bold">Banno Technologies</a> </p>
</div>
       ...
       $('.book_now_bnt').on('click', function(e){
           ...
           try{
               ...
               if( differenceInDays < 4){
                   ...
                   let message = "We allow 250 kms per day ( in 24 hours), In case user exceeds 250 kms limit in 1 day the user is liable to pay 6/- per km."
   
                   +" If user books car for 4 days or more than 4 days, there is no kms limit."
   
                   +" For more details read T&C point 20.";
