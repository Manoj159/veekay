...
<div class="header-inner-sumary pt-3">
                    ...
                    <div class="card fare-details delivery-info">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between final">
                                ...
                                <h6 class="fw-bold text-dark ">₹ <span class="final_paycls"><?=$payable?></span></h6>
                            ...
                            <div class="d-flex justify-content-between final">
                                ...
                                <h6 class="fw-bold text-dark ">₹ <span class="token_text"><?=$token = ($payable*25)/100;?></span></h6>
                            ...
                            <div class="form-check d-flex">
                                ...
                                <input type="checkbox" class="form-check-input me-2"  data-token='<?=$token;?>'  data-full='<?=$payable;?>' id="fullpay">
                            ...
                            <?php if($this->session->userdata('user_id') != ''){ ?>
                                  ...
                                  <a id='btnpayss' href="javascript:void(0)" onclick="makeMeVoid2()" class="btn action-btn-primary">Pay Now  ₹ <?=$token;?></a>

                                  <!--<a id='btnpayss' href="javascript:void(0)" onclick="makeMeVoid()" class="btn action-btn-primary">Pay Now  ₹ <?=$token;?></a>-->

                                <?php }else{?>

                                  <a id='btnpays' data-bs-toggle="modal" data-bs-target="#login-modal" class="btn action-btn-primary">Pay Now ₹  <?=$token;?></a>
    ...
    <script>
        ...
        function makeMeVoid2(){
            ...
            <?php  $this->session->set_userdata('total_payable',$total_payable); ?>
