                ...
                <div class="scrollbar-sidebar">
                    <div class="app-sidebar__inner">
                        <ul class="vertical-nav-menu">
                            ...
                            <li class="sub-menu <?php if($page_name == 'edit_profile' || $page_name == 'system_setting') echo 'mm-active'; ?>">
                            ...
                            <!-- <li>-->
                            <!--    <a href="<?= base_url(); ?>admin/modify_list" class="<?php if($page_name == "modify_list") { echo 'mm-active'; } ?>" >-->
                            ...
                            <!-- <li>
                                <a href="<?= base_url(); ?>admin/cancel_bookings" class="<?php if($page_name == "cancel_bookings") { echo 'mm-active'; } ?>" >

                                    <i class="metismenu-icon fa fa-list"></i>
                                    <?= ucwords("booking cancellation"); ?> 
                                </a>
                            </li> -->
                          ...
                          <li>
                           ...
                           <li>
                                <a href="<?= base_url(); ?>admin/page_list" class="<?php if($page_name == "page_list") { echo 'mm-active'; } ?>" >
                            ...
                            <li>
                                <a href="<?= base_url(); ?>admin/userlist" class="<?php if($page_name == "userlist") { echo 'mm-active'; } ?>" >
                            ...
                            <!-- <li>
                                <a href="<?= base_url(); ?>admin/about_us" class="<?php if($page_name == "about_us") { echo 'mm-active'; } ?>" >

                                    <i class="metismenu-icon fa fa-file"></i>
                                    <?= ucwords("Manage about us"); ?> 
                                </a>
                            </li>
                             -->
                            <!-- <li>
