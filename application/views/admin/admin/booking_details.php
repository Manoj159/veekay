			...
			<div class="card-body table-reponsive">
				...
				<div class="row">
					...
					<div class="col-md-4 border">
                       ...
                       $main = $start->diff($end); 
                       $total_hours = $main->days * 24 + $main->h + ($main->i / 60); // Converts days to hours and adds minutes as fraction
					...
					<div class="col-md-4 border">
						...
						<table class="table table-striped table-reponsive">
						    ...
						    <tr>
								<th>Total Fair </th>
								<td><i class="fa fa-inr"></i> <?= ($total_hours*$car->price) ?></td>
							</tr>
							<tr>
								<th>Total Discount Fare </th>
