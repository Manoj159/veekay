...
<div style="width: 700px; left: 1%; position: relative; line-height: 25px;">
    <img alt="happyeasyrides" src="<?= base_url("assets/mailer/"); ?>1.jpg" width="100%" loading="lazy"/>
    <br/>
    <p>Dear <?= $user->name; ?>,</p>
    <p>
        We are happy with you to complete your booking and thank you for choosing Happyeasy Rides as your self drive car
rental partner. Please check below payment details and booking details:
    </p>
    ...
    <p>
        ...
        <img alt="happyeasyrides" src="<?= base_url("assets/mailer/"); ?>4.jpg" loading="lazy" style="width: 150px !important;"/>
    </p>
    <br/>
    <img alt="happyeasyrides" src="<?= base_url("assets/mailer/"); ?>3.jpg" width="100%" loading="lazy"/>
</div>
</body>
</html>