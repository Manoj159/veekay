                    ...
                    <form action="<?= base_url(); ?>Book" method="get" id="searchCarForm">
                        <div class="filter-box-top d-flex">
                            ...
                            <div class="filter-item">
                                <input type="text" onchange="$('#startDateHere').val($(this).val());" name="start" id="start-date" minlength="<?= date('Y-m-d'); ?>"  class="start-timepicker date-picker" placeholder="2023-08-10 10:00"  required  value="<?= date('d-m-Y H:i', strtotime($_GET['start'])); ?>" readonly  />
                            </div>
                            <div class="filter-item">
                                        ...
                                        <div class="car-card card"> 
                                            ...
                                            <div class="align-items-center d-flex footer justify-content-between mt-3">
                                                ...
                                                <?php
                                                 ...
                                                 <?php  }else{ ?>
                                                     <a href="<?= base_url(); ?>Ford?car_id=<?= $c->car_id.'&&'.$_SERVER['QUERY_STRING']; ?>" class="btn btn-themed book_now_bnt">Book</a>
                                                 <?php }  ?>
