...
<!-- <section> -->
   <div class="d-flex align-items-center banner-sec-1" id="hero" style="padding-top: 50px;">
      <div class="row">
         <div class="col-lg-12">
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCjWvgyaXwhdSTSLXhFlQSIgpy8u2m4bZ8&libraries=places&v=weekly"></script>
