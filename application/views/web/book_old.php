        ...
        <?php  if(isset($_GET['city'])){
            ...
            if ($date_convert > $date_now) {
                ...
                <div class="card" style="opacity: <?= $card_opacity; ?>;">
                   <div class="card-body">
                      ...
                      <div class="booking-button">
                         ...
                         <a href="<?= base_url(); ?>Ford?car_id=<?= $c->car_id.'&&'.$_SERVER['QUERY_STRING']; ?>" class="btn book mt-5 car_book">book now</a>
                         <?php }  ?>
                      </div>
                   </div>
                </div>
              ...
              <?php }  
                    ...
                    $availability = "booked";  $card_opacity = 0.8;  $checkIfCarBooked = 0;  $car_id = $c->car_id;
