...
class User_model extends CI_Model
{
    ...
    public function register_user()
    {
        ...
        {
           $this->session->set_flashdata('error_message', 'Please Enter Same Password');
    ...
    public function book_car($data)
    {
     ...
     // end.. sanjay added 31-03-2022
        ...
        if( $data['only_security_amount'] )
        {
            $remainingAmount = $this->session->userdata('total_payable') - $this->session->userdata('refund');
        }
        ...
        @$data = array('user_id'=>$this->session->userdata('user_id'),
                      ...
                      'home_delivery'=>$this->session->userdata('check'),
